...
VARIANTS = {
    "classic": {},
    "bigred": {
        (248, 247, 255, 255): (255, 108, 108, 255),
        (175, 170, 189, 255): (223, 44, 44, 255),
        (118, 109, 124, 255): (214, 29, 35, 255),
        (53, 50, 65, 255): (127, 16, 16, 255),
        (10, 10, 13, 255): (0, 0, 0, 255),
        (194, 61, 74, 255): (20, 20, 22, 255),
        (137, 25, 49, 255): (8, 8, 10, 255),
        (91, 0, 36, 255): (0, 0, 0, 255),
        (88, 58, 65, 255): (28, 28, 30, 255),
        (182, 121, 101, 255): (22, 22, 24, 255),
        (236, 197, 153, 255): (36, 36, 38, 255),
        (150, 205, 249, 255): (32, 32, 36, 255),
        (99, 141, 224, 255): (14, 14, 18, 255),
        (70, 74, 189, 255): (0, 0, 0, 255),
    },
    "sand": {
